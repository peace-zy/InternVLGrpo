...
_import_structure = {
    ...
    "internvl_grpo_config": ["InternvlGRPOConfig"],
    "internvl_grpo_trainer": ["InternvlGRPOTrainer"],
    "internvl_rl_by_rule_config": ["InternvlRLByRuleConfig"],
    "internvl_rl_by_rule_trainer": ["InternvlRLByRuleTrainer"],
