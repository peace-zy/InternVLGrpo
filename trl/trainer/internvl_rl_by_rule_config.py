...
@dataclass
class InternvlRlByRuleConfig(TrainingArguments):
    r"""
    Configuration class for the [`InternvlRlByRuleTrainer`].
    ...
    Parameters:
        ...
        model_init_kwargs (`dict[str, Any]` or `None`, *optional*, defaults to `None`):
            ...
            argument of the [`InternvlRlByRuleTrainer`] is provided as a string.
        ...
        do_sample (`bool`, *optional*, defaults to `True`):
            Whether to sample completions.
        temperature (`float`, *optional*, defaults to `0.9`):
            Temperature for sampling. The higher the temperature, the more random the completions.
        top_p (`float`, *optional*, defaults to `1.0`):
            Top-p sampling ratio.
        top_k (`int`, *optional*, defaults to `10`):
            Top-k sampling ratio.
        ...
        reward_threshold (`float` or `None`, *optional*, defaults to `2/3`):
            Threshold for the reward.
        epsilon (`float` or `None`, *optional*, defaults to `0.1`):
            Advantages clipping parameter
    """
    ...
    do_sample: Optional[bool] = field(
        default=True,
        metadata={"help": "Whether to sample completions."},
    )
    ...
    top_p: Optional[float] = field(
        default=1.0,
        metadata={"help": "Top-p sampling ratio."},
    )
    top_k: Optional[int] = field(
        default=10,
        metadata={"help": "Top-k sampling ratio."},
    )
    ...
    reward_threshold: Optional[float] = field(
        default=0.95,
        metadata={
            "help": "Threshold for the reward. If the reward is below this threshold, the completion is discarded."
        },
    )
    epsilon: Optional[float] = field(
        default=0.1,
        metadata={
            "help": "Advantages clipping parameter"
        },
    )
